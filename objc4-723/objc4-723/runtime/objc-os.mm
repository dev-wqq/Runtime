...
void _objc_init(void)
{
    ...
    /**
     void _dyld_objc_notify_register(_dyld_objc_notify_mapped mapped, _dyld_objc_notify_init init,
     ...
     // grep -rne "registerObjCNotifiers" .
     // 在 dyld-421.1 中找到 ./dyld-421.1/src/dyld.cpp:4746
